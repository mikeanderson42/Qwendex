...
Qwendex `0.6.10` installs validated runtime generations side by side. Each
...
The installer requires `@openai/codex@0.150.0`, matching this release's
...
This checkout is seeded as `v0.6.10` and supports Codex `0.150.0`.
...
- Native Manager delegation integration is certified only on the tested Linux /
  Codex `0.150.0` canonical patch combination. Stock Codex remains supported for
