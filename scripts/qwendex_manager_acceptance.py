...
OFFLINE_TESTS = (
    ...
    "tests/smoke/test_qwendex_cli.py::test_qdex_manager_preflight_blocks_and_exports_env_before_launch",
    ...
    "tests/smoke/test_qwendex_cli.py::test_qwendex_manager_root_uses_preflight_identity_and_repo_lock",
    "tests/smoke/test_qwendex_cli.py::test_qwendex_manager_root_reclaims_dead_launcher_lease",
    "tests/smoke/test_qwendex_cli.py::test_qwendex_manager_preflight_records_decision_ledger_and_hook_status",
    "tests/smoke/test_qwendex_cli.py::test_manager_prompt_admission_keeps_launch_local_routing_after_global_toggle",
    ...
    "tests/smoke/test_qwendex_cli.py::test_manager_prompt_admission_contract_by_mode",
    "tests/smoke/test_qwendex_cli.py::test_manager_hook_messages_never_expose_configured_gpt_model",
    "tests/smoke/test_qwendex_cli.py::test_manager_subagent_start_binds_exact_plan_without_pretool_reservation",
    "tests/smoke/test_qwendex_cli.py::test_manager_ultra_source_survives_admission_and_session_status",
    "tests/smoke/test_qwendex_cli.py::test_manager_rejects_tampered_immutable_policy_snapshot",
    "tests/smoke/test_qwendex_cli.py::test_manager_required_lane_stop_gate_and_session_status",
    "tests/smoke/test_qwendex_cli.py::test_qwendex_agent_hooks_enforce_final_contract_and_manager_stop_gate",
    "tests/smoke/test_qwendex_cli.py::test_qwendex_manager_direct_work_exception_requires_validation_evidence",
    "tests/smoke/test_qwendex_cli.py::test_qwendex_agent_hook_config_generation_and_write_gate",
    "tests/smoke/test_qwendex_cli.py::test_qwendex_agent_pre_tool_hook_denies_unsafe_actions",
    "tests/smoke/test_qwendex_cli.py::test_qwendex_read_only_shell_gate_is_fail_closed_and_quote_aware",
    "tests/smoke/test_qwendex_cli.py::test_qwendex_read_only_non_shell_tool_gate_is_fail_closed",
    "tests/smoke/test_qwendex_cli.py::test_qwendex_manager_reconciles_stale_read_only_and_blocks_stale_writers",
    ...
    "tests/smoke/test_qwendex_cli.py::test_qwendex_manager_enforces_subagent_limit_per_repository",
    "tests/smoke/test_qwendex_cli.py::test_qwendex_concurrent_manager_assignments_cannot_exceed_subagent_limit",
    ...
    payload: dict[str, Any] = {
        ...
        **runtime,
        ...
        "coverage_contract": {
            ...
            "direct_work_exceptions": True,
            "required_lanes_and_verifier": True,
