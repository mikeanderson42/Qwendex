...
CODEX_CONTEXT_WINDOW="${LOCAL_QWEN_CODEX_CONTEXT_WINDOW:-${CODEX_TEXTGEN_CONTEXT_LIMIT_TOKENS:-65536}}"
CODEX_AUTO_COMPACT_LIMIT="${LOCAL_QWEN_CODEX_AUTO_COMPACT_LIMIT:-56000}"
...
Environment overrides:
  ...
  LOCAL_QWEN_CODEX_CONTEXT_WINDOW default: 65536
  LOCAL_QWEN_CODEX_AUTO_COMPACT_LIMIT default: 56000
