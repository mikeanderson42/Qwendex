...
def run_acceptance(run_id: str, output_root: Path) -> dict[str, Any]:
    ...
    if stock_version.returncode or "0.144.0" not in (stock_version.stdout + stock_version.stderr):
        raise InstallAcceptanceError("stock Codex does not match the supported 0.144.0 build contract")
