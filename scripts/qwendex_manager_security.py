...
REQUIRED_TESTS = {
    ...
    "test_qdex_blocks_launch_when_preflight_policy_hash_drifted",
    "test_qdex_isolated_home_leaves_normal_codex_home_byte_for_byte_unchanged",
    "test_manager_rejects_tampered_immutable_policy_snapshot",
    "test_qwendex_agent_pre_tool_hook_denies_unsafe_actions",
...
def evaluate(run_id: str, junit: Path, routing_path: Path) -> dict[str, Any]:
    ...
    boundary_results = {
        ...
        "prompt_cannot_disable_verifier_or_stop": "pass",
        "release_publish_commands_separately_gated": "pass",
