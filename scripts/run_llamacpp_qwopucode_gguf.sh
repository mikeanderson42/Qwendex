...
MODEL_ALIAS="${LLAMACPP_MODEL_ALIAS:-Qwopucode-full-v15-27B-FP8-Block-i1-Q4_K_M}"
MODEL_PATH="$(windows_to_wsl_path "${LLAMACPP_MODEL_PATH:-/mnt/c/Users/Tweak/.lmstudio/models/Qwen36/mradermacherQwopucode-full-v15-27B/Qwopucode-full-v15-27B-FP8-Block.i1-Q4_K_M.gguf}")"
