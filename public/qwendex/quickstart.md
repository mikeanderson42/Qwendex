...
The dependency helper requires Codex CLI `0.154.0`, the version covered by this
...
For the supported Codex `0.154.0` runtime, Qdex canonicalizes and validates the
...
```text
>_ OpenAI Codex (v0.154.0) /w Qwendex
```
