...
The dependency helper requires Codex CLI `0.153.1`, the version covered by this
...
For the supported Codex `0.153.1` runtime, Qdex canonicalizes and validates the
...
```text
>_ OpenAI Codex (v0.153.1) /w Qwendex
```
