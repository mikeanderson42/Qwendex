...
The dependency helper requires Codex CLI `0.147.0`, the version covered by this
...
For the supported Codex `0.147.0` runtime, Qdex canonicalizes and validates the
...
```text
>_ OpenAI Codex (v0.147.0) /w Qwendex
```
